# ARC 2.2.0 Mac installation design
...
Terse specification is the complete repository v1.0 text, with its SHA-256 sidecar;
...
/usr/bin/xcrun stapler validate ARC-2.2.0.dmg
